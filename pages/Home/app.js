...
var colorWheel = window.localStorage.getItem("colorWheel");
var definition = window.localStorage.getItem("definition");
var timeLimit = window.localStorage.getItem("timeLimit");
var timeSpent = window.localStorage.getItem("timeSpent");

var colrWheelDiv = document.querySelector(".colorForm");
var definitionDiv = document.querySelector(".definition");
var timeSpentDiv = document.querySelector(".timeSpent")
var timeLimitDiv = document.querySelector(".set-form");

if(colorWheel == "false"){
    colrWheelDiv.innerHTML = "";
...
button.addEventListener("click",function(event){
    ...
    userlvl=document.getElementById("demo");
    userxtra=document.getElementById("chkxtra");
    let xtra = userxtra.checked ? 1 : 0;
    let level = userlvl.innerHTML;
    let current_fill_color=fill_color.value;
    let current_border_color=border_color.value;
    let params={
        active : true,
        currentWindow: true
    }
    ...
    function gotTabs(tabs)
    {
        let msg ={
            ...
            lvl: level,
            rel: xtra,
            fill_col : current_fill_color,
            bor_col : current_border_color
        };
